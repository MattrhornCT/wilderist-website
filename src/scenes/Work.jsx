    ...
    >
      <div
        style={{
          ...
          aspectRatio: "16/10",
          background: imageBg,
          backgroundImage: imageBgPattern
            ? `url(${imageBgPattern})`
            : undefined,
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ marginBottom: "clamp(24px,4vw,44px)" }}>
          ...
          >
            One you can play today. One in active development. Open either to
            learn more.
          </p>
        </div>
        <div
        ...
        >
          <WorkCard
            ...
            title="Cube Conquest"
            description="A bite-sized tic-tac-toe strategy game you can play right now in your browser. Claim the cube face by face."
            image={ccLogo}
            imageFit="contain"
            imageBg="#0d1520"
