...
import ccItchScreenshot from "../assets/CC_ItchIO_Screenshot.png";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          A bite-sized tic-tac-toe strategy game you can play right now in your
          browser. Claim the cube face by face, and hold your ground for just{" "}
          <span
            style={{
        ...
        >
          ...
          >
            <img
              src={ccItchScreenshot}
              alt="Cube Conquest on itch.io"
              style={{
                position: "absolute",
                inset: 0,
                width: "100%",
            ...
            <a
              ...
              style={{
                ...
                background:
                  "linear-gradient(180deg, rgba(11,16,23,.15), rgba(11,16,23,.65))",
            ...
            >
              ...
              <span style={{ fontSize: 12.5, color: "var(--faint)" }}>
                Opens on itch.io · Free · No install
              </span>
            </a>
          </div>
        </div>
