...
export const FEATURES = [
  {
    icon: "◧",
    t: "Claim the Cube",
    d: "Stake territory face by face and fight for every contested side.",
  },
  {
    icon: "⏱",
    t: "Quick sessions",
    d: "Rounds you can finish in a few minutes — a break or a binge.",
  },
  {
    icon: "⚲",
    t: "Free Demo in browser",
    d: "No download, no account. Click play and you are in a match.",
  },
  {
    icon: "↻",
    t: "One more turn",
    d: "Tight, readable decisions that keep pulling you back.",
  },
];
